...
export 'network/network_printer.dart';

class SmartThermalPrinterFlutter {
  SmartThermalPrinterFlutter._();

  static SmartThermalPrinterFlutter? _instance;

  static SmartThermalPrinterFlutter get instance {
    FlutterBluePlus.setLogLevel(LogLevel.debug);
    _instance ??= SmartThermalPrinterFlutter._();
    return _instance!;
  }
