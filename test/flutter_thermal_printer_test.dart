...
void main() {
  final SmartThermalPrinterFlutterPlatform initialPlatform = SmartThermalPrinterFlutterPlatform.instance;

  test('$MethodChannelSmartThermalPrinterFlutter is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelSmartThermalPrinterFlutter>());
  });

  test('getPlatformVersion', () async {
    SmartThermalPrinterFlutter smartThermalPrinterFlutterPlugin = SmartThermalPrinterFlutter.instance;
    MockSmartThermalPrinterFlutterPlatform fakePlatform = MockSmartThermalPrinterFlutterPlatform();
